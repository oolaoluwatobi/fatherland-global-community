...
export default function Intrestedinlearning() {
  return (
    ...
    <div className={`max-w-[90rem] mx-auto ${style.bt2} bg-[#fff3e5] pt-5 lg:mt-[7rem] mt-8 lg:pb-[6.563rem] pb-5 lg:pt-[6.625rem]`}>
        ...
        <p className='text-[#002a0c] lg:text-[40px] mx-auto text-center pb-[0.313rem]
         lg:text-start text-xl font-bold  lg:leaing-[50px] break-words'>Interested in learning more on African cultures and values?</p>
