...
export default function Categories() {
  return (
    <div className={`max-w-[90rem] mx-auto ${style.cat} pt-12`}>
        <p className='text-center font-bold text-xl lg:text-[40px] lg:leading-[58px] break-words container pb-4'> Explore Cultural Learning Categories</p>
        <p className='text-black text-sm lg:text-base font-normal leading-6 break-words text-center pb-14 container'>We make it easy video courses with professional, creative 
        <br />experts from around the world</p>
        ...
        {ExploreCulturalLearningCategories.map((list, i) => (
            ...
            >
                ...
                <Link href={list.href} className='flex items-center justify-center text-[#26D44B] text-sm font-normal
