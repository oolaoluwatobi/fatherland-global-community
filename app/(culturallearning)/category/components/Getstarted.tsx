...
export default function Getstarted() {
  return (
    ...
    <p className='text-center text-[#002a0c] font-medium lg:leading-8 break-words lg:text-xl text-sm'>Get unlimited access to various bite-sized lessons on Africa.</p>
    </main>
