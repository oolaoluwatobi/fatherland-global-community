  ...
  return (
    <div className='mx-auto max-w-[90rem] mb-5'>
        ...
        <input
          ...
          className="bg-white lg:w-[rem] w-full mxauto h-[3.9rem] pl5 text-gray-200 text-xl mt-10  shadow-lg pl-4"
        />
        ...
        <div className={`${style.Affrobg} mt-10  mx-auto max-w-[90rem] pt-[4.125rem]`}>
           <div className='flex justify-start'>
           <div className='ml[15rem] h-1 border-l-[5px] border-t-[5px]  border-b-[5px] w-[44.313rem] pt-[2.75rem] border-l-white '>
              <p className={`font-normal text-[#fff] text-3xl ml-[1.438rem] `}>Afrocentric</p>
              <p className={` text-[#fff] font-sans font-[700] text-3xl ml-[10.938rem]`}> Clothing</p>
           </div>
           <Image src={image54} alt="" className='mt-8 ml-5 w-[36.563rem] h-[20.875rem]' />
           </div>
        </div>
