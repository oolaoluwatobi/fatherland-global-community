  ...
  return (
    <div className=' max-w-[90rem] bg-[#e6f5f9] mx-auto'>
        ...
        {joinFatherlandCommunityBanner.map((list, i) => (
            <div
            key={i}
            className={`pb-[4.438rem] pt-[3.25rem] lg:flex justify-around items-center mx-auto container`}
            >
            ...
            <p className='text-5xl font-extrabold leading-10 break-words pb-[1.375rem] text-[#0BA1BA] pr-[0.563rem]'>{list.label2}</p>
