      ...
      <div className="mx-auto max-w-[70rem]">
        ...
        <div className="flex gap mt-5">
          <div className="mt-6 w-[28rem] h-[28rem]">
            ...
            />
            <Image
              className="w-[6.5rem] h-[6.5rem] rounded-lg mt-2"
      ...
      <div className="max-w-[70rem] mx-auto">
        <div className=" ml4 flex bg-orange-100 pt-3 pl-8 mt-5 h-[3rem] gap-24">
          ...
          <p className="text-[#b8b4b4]">
            {renderStoredescription?.specificate}
          </p>
          <p className="text-[#b8b4b4]">{renderStoredescription?.review}</p>
          <p className="text-[#b8b4b4]">{renderStoredescription?.questions}</p>
        </div>
        <div>
