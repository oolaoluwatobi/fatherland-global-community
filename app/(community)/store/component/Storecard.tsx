    ...
    <div>
      <div className="bg-black p-16 rounded-3xl ">
        <div className="mx-auto grid grid-cols-2 relative  gap-4 mt-10 bg-gradient-to-r from-cyan-600  to-green-500  p-10 ">
          ...
          <button className=" absolute top-11 mr-7   right-4 bg-gradient-to-r from-cyan-600  to-green-500  w-[7.05rem] h-[4rem] text-center px- text-[#ffffff] rounded-full">Subscribe</button>
        </div>
