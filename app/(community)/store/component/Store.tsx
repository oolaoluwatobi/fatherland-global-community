...
export default function Store() {
  return (
    <div className=" mx-auto  ">
      ...
      <div className={`${style.storebg} mt-10 pl-[2.188rem] w-full max-w-[97.813rem]  mx-auto `}>
        <p className="text-bold font-bold lg:text-5xl pt-28">
          Handcrafted products <br /> inspired by{" "}
          <span className="text-[#DA5001]">Africans</span>{" "}
        </p>
        <p className=" pt-5 lg:text-bold font-[500] text-lg text-gray-500">
