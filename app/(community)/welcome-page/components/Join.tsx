...
export default function Join() {
  return (
    <div className=' max-w-[90rem] bg-[#fcf1e5] mx-auto  pb-[5rem] lg:flex justify-around items-center'>
        ...
        <div className={` mx-auto lg:w-[45rem] h[23.125rem] mb5 border-[10px] border-primary border-l-0 border-t-0 border-b-0 lg:ps12`}>
