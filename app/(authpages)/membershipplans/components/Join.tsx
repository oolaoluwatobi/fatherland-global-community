    ...
    <div className=" bg-[#fcf1e5] mx-auto">
     ...
     {joinFatherlandCommunityBanner.map((list, i) => (
        ...
        >
          ...
          <div
            className={`${style.bleft} mx-auto lg:w-[45rem] h[23.125rem] mb5 border-[10px] borderprimary border-l-0 border-t-0 border-b-0 lg:ps12 rounded-t-[10px] rounded-b-[10px]`}
          >
