...
export const COMMUNITY = [
  {
    ...
    content:
      " FATHERLAND COMMUNITY reveals how a group of people is bound geographically, culturally, linguistically, religiously, and economically in the challenging world for Africans and African Descendants. The self-sustainable concept focuses on self-determination to flourish and become a vibrant, courageous, and proud community for Africans and African Descendants worldwide.",
  },
];
...
export const ADVERTISE = [
  {
    ...
    text1:
      "Our advertising solutions are designed to meet the specific needs for brands and businesses around the world",
  },
];
...
export const Advertcontents = [
  {
    ...
    text: "Branded Content",
    text1:
      "We help you define your brand's personality, positioning, and messaging to ensure a cohesive and impactful advertising strategy. We specialize in creating targeted and optimized digital advertising campaigns across various platforms, including social media, search engines, and display networks.",
  },
...

  {
    ...
    text: "Distribution",
    text1:
      "At Fatherland, we understand that distribution is the key to a successful advertising campaign. Our dedicated team of experts specializes in strategically distributing your ads to the right channels, maximizing your brand&apos,s visibility and generating quality leads.",
  },
  ...
  },
  {
    ...
    text: "Accelerator Programs",
    text1:
      "Through our unique accelerator program, your organization can be part of an initiative to drive innovation in your sector, region, or for a social cause, amplified via Fatherland’s global network.",
  },
  {
    id: "6",
    image: Group37016,
    ...
    text1:
      "Fatherland’s global portfolio includes iconic entertainment, Education, and Ecommerce brands. Our dedicated team can help you build smarter, more targeted solutions for your brand.",
  },
];
...
export const StorehotDeal = [
  {
    id: "1",
    image: box,
    content: "Raffia Handbag(Box), Woven Shoulder Bag.",
